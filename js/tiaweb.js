/**
 * Tiaweb Components in CSS, JS and HTML
 * @version v1.3.0
 * @link https://tiaweb.github.io
 */
! function() {
    "use strict";
    ...
    function e(e, t) {
        if (e) {
            if (t.element_.classList.contains(t.CssClasses_.TIAWEB_JS_RIPPLE_EFFECT)) {
                ...
                s.classList.add(t.CssClasses_.TIAWEB_RIPPLE_CONTAINER), s.classList.add(t.CssClasses_.TIAWEB_JS_RIPPLE_EFFECT);
                var i = document.createElement("span");
                i.classList.add(t.CssClasses_.TIAWEB_RIPPLE), s.appendChild(i), e.appendChild(s)
            }
    ...
    s = function() {
        ...
        function a(n, a) {
            if (!("object" == typeof n && n instanceof Element)) throw new Error("Invalid argument provided to upgrade TIAWEB element.");
            var l = i("tiaweb-componentupgrading", !0, !0);
            if (n.dispatchEvent(l), !l.defaultPrevented) {
                ...
                for (var d, h = 0, u = r.length; h < u; h++) {
                    ...
                    var I = i("tiaweb-componentupgraded", !0, !1);
                    n.dispatchEvent(I)
                }
            }
        }
        ...
        function o(t) {
            ...
            if (c.forEach(function(e) {
                ...
                }), t.constructor.prototype.hasOwnProperty(C)) throw new Error("TIAWEB component classes must not have " + C + " defined as a property.");
        ...
        function d(e) {
            if (e) {
                ...
                var a = i("tiaweb-componentdowngraded", !0, !1);
        ...
        var c = [],
            p = [],
            C = "tiawebComponentConfigInternal_";
        return {
            upgradeDom: n,
            upgradeElement: a,
            upgradeElements: l,
        ...
        "classList" in document.createElement("div") && "querySelector" in document && "addEventListener" in window && Array.prototype.forEach ? (document.documentElement.classList.add("tiaweb-js"), s.upgradeAllRegistered()) : (s.upgradeElement = function() {}, s.register = function() {})
    ...
    window.MaterialButton = o, o.prototype.Constant_ = {}, o.prototype.CssClasses_ = {
        RIPPLE_EFFECT: "tiaweb-js-ripple-effect",
        RIPPLE_CONTAINER: "tiaweb-button__ripple-container",
        RIPPLE: "tiaweb-ripple"
    ...
    window.MaterialCheckbox = r, r.prototype.Constant_ = {
        ...
        INPUT: "tiaweb-checkbox__input",
        BOX_OUTLINE: "tiaweb-checkbox__box-outline",
        FOCUS_HELPER: "tiaweb-checkbox__focus-helper",
        TICK_OUTLINE: "tiaweb-checkbox__tick-outline",
        RIPPLE_EFFECT: "tiaweb-js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "tiaweb-js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "tiaweb-checkbox__ripple-container",
        RIPPLE_CENTER: "tiaweb-ripple--center",
        RIPPLE: "tiaweb-ripple",
    ...
    window.MaterialIconToggle = _, _.prototype.Constant_ = {
        ...
        INPUT: "tiaweb-icon-toggle__input",
        JS_RIPPLE_EFFECT: "tiaweb-js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "tiaweb-js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "tiaweb-icon-toggle__ripple-container",
        RIPPLE_CENTER: "tiaweb-ripple--center",
        RIPPLE: "tiaweb-ripple",
        IS_FOCUSED: "is-focused",
        IS_DISABLED: "is-disabled",
        ...
        cssClass: "tiaweb-js-icon-toggle",
        widget: !0
    });
    var d = function(e) {
        this.element_ = e, this.init()
    ...
    window.MaterialMenu = d, d.prototype.Constant_ = {
        ...
        CONTAINER: "tiaweb-menu__container",
        OUTLINE: "tiaweb-menu__outline",
        ITEM: "tiaweb-menu__item",
        ITEM_RIPPLE_CONTAINER: "tiaweb-menu__item-ripple-container",
        RIPPLE_EFFECT: "tiaweb-js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "tiaweb-js-ripple-effect--ignore-events",
        RIPPLE: "tiaweb-ripple",
        IS_UPGRADED: "is-upgraded",
        ...
        BOTTOM_LEFT: "tiaweb-menu--bottom-left",
        BOTTOM_RIGHT: "tiaweb-menu--bottom-right",
        TOP_LEFT: "tiaweb-menu--top-left",
        TOP_RIGHT: "tiaweb-menu--top-right",
        UNALIGNED: "tiaweb-menu--unaligned"
    ...
    window.MaterialRadio = c, c.prototype.Constant_ = {
        ...
        IS_CHECKED: "is-checked",
        IS_UPGRADED: "is-upgraded",
        JS_RADIO: "tiaweb-js-radio",
        RADIO_BTN: "tiaweb-radio__button",
        RADIO_OUTER_CIRCLE: "tiaweb-radio__outer-circle",
        RADIO_INNER_CIRCLE: "tiaweb-radio__inner-circle",
        RIPPLE_EFFECT: "tiaweb-js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "tiaweb-js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "tiaweb-radio__ripple-container",
        RIPPLE_CENTER: "tiaweb-ripple--center",
        RIPPLE: "tiaweb-ripple"
    ...
    window.MaterialSlider = p, p.prototype.Constant_ = {}, p.prototype.CssClasses_ = {
        IE_CONTAINER: "tiaweb-slider__ie-container",
        SLIDER_CONTAINER: "tiaweb-slider__container",
        BACKGROUND_FLEX: "tiaweb-slider__background-flex",
        BACKGROUND_LOWER: "tiaweb-slider__background-lower",
        BACKGROUND_UPPER: "tiaweb-slider__background-upper",
    ...
    window.MaterialSnackbar = C, C.prototype.Constant_ = {
        ...
        SNACKBAR: "tiaweb-snackbar",
        MESSAGE: "tiaweb-snackbar__text",
        ACTION: "tiaweb-snackbar__action",
        ACTIVE: "tiaweb-snackbar--active"
    ...
    window.MaterialSpinner = u, u.prototype.Constant_ = {
        ...
        TIAWEB_SPINNER_LAYER: "tiaweb-spinner__layer",
        TIAWEB_SPINNER_CIRCLE_CLIPPER: "tiaweb-spinner__circle-clipper",
        TIAWEB_SPINNER_CIRCLE: "tiaweb-spinner__circle",
        TIAWEB_SPINNER_GAP_PATCH: "tiaweb-spinner__gap-patch",
        TIAWEB_SPINNER_LEFT: "tiaweb-spinner__left",
        TIAWEB_SPINNER_RIGHT: "tiaweb-spinner__right"
    }, u.prototype.createLayer = function(e) {
        var t = document.createElement("div");
        t.classList.add(this.CssClasses_.TIAWEB_SPINNER_LAYER), t.classList.add(this.CssClasses_.TIAWEB_SPINNER_LAYER + "-" + e);
        var s = document.createElement("div");
        s.classList.add(this.CssClasses_.TIAWEB_SPINNER_CIRCLE_CLIPPER), s.classList.add(this.CssClasses_.TIAWEB_SPINNER_LEFT);
        var i = document.createElement("div");
        i.classList.add(this.CssClasses_.TIAWEB_SPINNER_GAP_PATCH);
        var n = document.createElement("div");
        n.classList.add(this.CssClasses_.TIAWEB_SPINNER_CIRCLE_CLIPPER), n.classList.add(this.CssClasses_.TIAWEB_SPINNER_RIGHT);
        for (var a = [s, i, n], l = 0; l < a.length; l++) {
            var o = document.createElement("div");
            o.classList.add(this.CssClasses_.TIAWEB_SPINNER_CIRCLE), a[l].appendChild(o)
        }
    ...
    window.MaterialSwitch = E, E.prototype.Constant_ = {
        ...
        INPUT: "tiaweb-switch__input",
        TRACK: "tiaweb-switch__track",
        THUMB: "tiaweb-switch__thumb",
        FOCUS_HELPER: "tiaweb-switch__focus-helper",
        RIPPLE_EFFECT: "tiaweb-js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "tiaweb-js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "tiaweb-switch__ripple-container",
        RIPPLE_CENTER: "tiaweb-ripple--center",
        RIPPLE: "tiaweb-ripple",
        IS_FOCUSED: "is-focused",
        IS_DISABLED: "is-disabled",
    ...
    window.MaterialTabs = m, m.prototype.Constant_ = {}, m.prototype.CssClasses_ = {
        TAB_CLASS: "tiaweb-tabs__tab",
        PANEL_CLASS: "tiaweb-tabs__panel",
        ACTIVE_CLASS: "is-active",
        UPGRADED_CLASS: "is-upgraded",
        TIAWEB_JS_RIPPLE_EFFECT: "tiaweb-js-ripple-effect",
        TIAWEB_RIPPLE_CONTAINER: "tiaweb-tabs__ripple-container",
        TIAWEB_RIPPLE: "tiaweb-ripple",
        TIAWEB_JS_RIPPLE_EFFECT_IGNORE_EVENTS: "tiaweb-js-ripple-effect--ignore-events"
    }, m.prototype.initTabs_ = function() {
        this.element_.classList.contains(this.CssClasses_.TIAWEB_JS_RIPPLE_EFFECT) && this.element_.classList.add(this.CssClasses_.TIAWEB_JS_RIPPLE_EFFECT_IGNORE_EVENTS), this.tabs_ = this.element_.querySelectorAll("." + this.CssClasses_.TAB_CLASS), this.panels_ = this.element_.querySelectorAll("." + this.CssClasses_.PANEL_CLASS);
    ...
    window.MaterialTextfield = L, L.prototype.Constant_ = {
        ...
        LABEL: "tiaweb-textfield__label",
        INPUT: "tiaweb-textfield__input",
        IS_DIRTY: "is-dirty",
        IS_FOCUSED: "is-focused",
        IS_DISABLED: "is-disabled",
    ...
    window.MaterialTooltip = I, I.prototype.Constant_ = {}, I.prototype.CssClasses_ = {
        IS_ACTIVE: "is-active",
        BOTTOM: "tiaweb-tooltip--bottom",
        LEFT: "tiaweb-tooltip--left",
        RIGHT: "tiaweb-tooltip--right",
        TOP: "tiaweb-tooltip--top"
    ...
    window.MaterialLayout = f, f.prototype.Constant_ = {
        ...
        HEADER: "tiaweb-layout__header",
        DRAWER: "tiaweb-layout__drawer",
        CONTENT: "tiaweb-layout__content",
        DRAWER_BTN: "tiaweb-layout__drawer-button",
        ICON: "material-icons",
        JS_RIPPLE_EFFECT: "tiaweb-js-ripple-effect",
        RIPPLE_CONTAINER: "tiaweb-layout__tab-ripple-container",
        RIPPLE: "tiaweb-ripple",
        RIPPLE_IGNORE_EVENTS: "tiaweb-js-ripple-effect--ignore-events",
        HEADER_SEAMED: "tiaweb-layout__header--seamed",
        HEADER_WATERFALL: "tiaweb-layout__header--waterfall",
        HEADER_SCROLL: "tiaweb-layout__header--scroll",
        FIXED_HEADER: "tiaweb-layout--fixed-header",
        OBFUSCATOR: "tiaweb-layout__obfuscator",
        TAB_BAR: "tiaweb-layout__tab-bar",
        TAB_CONTAINER: "tiaweb-layout__tab-bar-container",
        TAB: "tiaweb-layout__tab",
        TAB_BAR_BUTTON: "tiaweb-layout__tab-bar-button",
        TAB_BAR_LEFT_BUTTON: "tiaweb-layout__tab-bar-left-button",
        TAB_BAR_RIGHT_BUTTON: "tiaweb-layout__tab-bar-right-button",
        TAB_MANUAL_SWITCH: "tiaweb-layout__tab-manual-switch",
        PANEL: "tiaweb-layout__tab-panel",
        ...
        IS_UPGRADED: "is-upgraded",
        IS_ANIMATING: "is-animating",
        ON_LARGE_SCREEN: "tiaweb-layout--large-screen-only",
        ON_SMALL_SCREEN: "tiaweb-layout--small-screen-only"
        ...
        cssClass: "tiaweb-js-layout"
    });
    var b = function(e) {
        this.element_ = e, this.init()
    };
    window.MaterialDataTable = b, b.prototype.Constant_ = {}, b.prototype.CssClasses_ = {
        DATA_TABLE: "tiaweb-data-table",
        SELECTABLE: "tiaweb-data-table--selectable",
        SELECT_ELEMENT: "tiaweb-data-table__select",
        ...
        return t ? function() {
            ...
            var t, i;
            if (e.checked)
                for (t = 0; t < s.length; t++) i = s[t].querySelector("td").querySelector(".tiaweb-checkbox"), i.MaterialCheckbox.check(), s[t].classList.add(this.CssClasses_.IS_SELECTED);
            else
                for (t = 0; t < s.length; t++) i = s[t].querySelector("td").querySelector(".tiaweb-checkbox"), i.MaterialCheckbox.uncheck(), s[t].classList.remove(this.CssClasses_.IS_SELECTED)
        }.bind(this) : void 0
    }, b.prototype.createCheckbox_ = function(e, t) {
        var i = document.createElement("label"),
            n = ["tiaweb-checkbox", "tiaweb-js-checkbox", "tiaweb-js-ripple-effect", this.CssClasses_.SELECT_ELEMENT];
        i.className = n.join(" ");
        var a = document.createElement("input");
        return a.type = "checkbox", a.classList.add("tiaweb-checkbox__input"), e ? (a.checked = e.classList.contains(this.CssClasses_.IS_SELECTED), a.addEventListener("change", this.selectRow_(a, e))) : t && a.addEventListener("change", this.selectRow_(a, null, t)), i.appendChild(a), s.upgradeElement(i, "MaterialCheckbox"), i
    ...
    window.MaterialRipple = S, S.prototype.Constant_ = {
        ...
        RIPPLE_CENTER: "tiaweb-ripple--center",
        RIPPLE_EFFECT_IGNORE_EVENTS: "tiaweb-js-ripple-effect--ignore-events",
        RIPPLE: "tiaweb-ripple",
        IS_ANIMATING: "is-animating",
        IS_VISIBLE: "is-visible"
        ...
        cssClass: "tiaweb-js-ripple-effect",
        widget: !1
    })
}();
